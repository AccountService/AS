    ...
    <center>
        <?php
            ...
            if($user->keyExist($DB)) {
                ...
                echo "<br><br><span style='display:inline-block'>Amount of request:</span><div class=''>
                      <input type='text' name='Amount' value='100' style='width: 30px; display:inline-block'>
